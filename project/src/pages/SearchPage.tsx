...
export function SearchPage({ 
  ...
  const results = useMemo(() => {
    ...
    return { conversations: matchedConversations, projects: matchedProjects };
  }, [query, conversations, projects]);
      ...
      <div className="mt-8 flex-1 overflow-y-auto scrollbar-thin">
        {!query.trim() ? (
          ...
          <div className="space-y-8 pb-12">
            ...
            {results.projects.length === 0 && results.conversations.length === 0 && (
              <div className="flex h-40 flex-col items-center justify-center text-ink-400">
